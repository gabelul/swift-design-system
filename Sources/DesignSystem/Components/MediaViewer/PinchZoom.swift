...
// Pinch-to-zoom implementation used internally by MediaViewer.
// Reference: a direct port of Kavsoft's "Pinch to Zoom | SwiftUI | iOS 17" (2024-03).
...
/// Zoom Container View
/// Displays the view being zoomed on the container's topmost layer
...
/// Observable class that shares state between the container and the inner view
@Observable
